...
- (void)restartSleepTimer {
    [[NetworkManager_Wrapper connectionQueue] run:^{
        [self->_sleepTimer resetWithTimeout:sleepTimeout];
    }];
}
...
- (void)onConnectionConnected:(Connection *)connection {
    [[NetworkManager_Wrapper connectionQueue] run:^{
        ...
        self->_isConnectionConnected = true;
...
- (void)onConnectionClosed:(Connection *)connection {
    [[NetworkManager_Wrapper connectionQueue] run:^{
        ...
        self->_isConnectionConnected = false;
        self->_connection.delegate = nil;
...
- (void)onNetworkReachabilityChanged:(bool)isReachable {
    [[NetworkManager_Wrapper connectionQueue] run:^{
        self->_isNetworkAvailable = isReachable;
...
- (void)startReconnectionTimer:(NSTimeInterval)timeout {
    ...
    [[NetworkManager_Wrapper connectionQueue] run:^{
        ...
        self->_retryTimer = [[PMTimer alloc] initWithTimeout:timeout repeat:false completionFunction:^{
